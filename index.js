...
let variable = 'husnain';
let uppercase = variable.toUpperCase();
console.log(uppercase);
let variable1 = "ABDULLAH";
let lowercase = variable1.toLowerCase();
console.log(lowercase);
//Famous Quote: Find a quote from a famous person you admire. Print the quote and the name of its author. Your output should look something like the following, including the quotation marks:
let Famouscquote = "A person who never made a mistake never tried anything ";
...
let listOfRivers = ["river of chenab", "river of jehlum", "river if sindh",];
let listOfMountain = ["mounteverst", "k2", "koh-e-himaliya", "ganga choti"];
let listOfCity = ["london", "washing DC", "istanbul", "faisalabad"];
let listOfLanguage = ["english", "french", "urdu", "punjabi", "farsi"];
let mountains = [
    {
        name: "K2",
        height: 8611,
